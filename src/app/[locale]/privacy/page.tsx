...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const titles: Record<string, string> = {
    pl: 'Polityka prywatności | WBS',
    de: 'Datenschutz | WBS',
    en: 'Privacy Policy | WBS',
  };
  const descriptions: Record<string, string> = {
    pl: 'Informacje o ochronie danych osobowych w szkole WBS',
    de: 'Informationen zum Datenschutz an der WBS-Schule',
    en: 'Data protection and privacy information for WBS school',
  };
        ...
        <div className="container-custom py-12 md:py-16">
          ...
          <div className="mx-auto max-w-4xl">
            <nav className="mb-8 flex items-center space-x-2 text-sm">
              <Link href={`/${locale}`} className="text-neutral-500 hover:text-accent-600">
                {t('navigation.home')}
              </Link>
            ...
            <div className="prose-custom prose max-w-none rounded-2xl bg-white p-6 shadow-sm md:p-10">
              ...
              <section className="mb-8">
                ...
                <p>
                  ...
                  {' '}
                  <Link href={`/${locale}/cookies`} className="text-red-600 hover:underline">
